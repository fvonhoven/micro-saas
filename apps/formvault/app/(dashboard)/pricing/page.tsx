...
export default function PricingPage() {
  ...
  const plans = [
    { ...PLAN_METADATA.formvault.free, id: "free" },
    { ...PLAN_METADATA.formvault.solo, id: "solo" },
    { ...PLAN_METADATA.formvault.pro, id: "pro" },
    { ...PLAN_METADATA.formvault.agency, id: "agency" },
  ]
    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-xl font-bold">FormVault</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">Secure document collection made simple</p>
          ...
          <div className="inline-flex items-center bg-white rounded-lg p-1 shadow-sm">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-md transition-colors ${
                billingCycle === "annual" ? "bg-purple-600 text-white" : "text-gray-600 hover:text-gray-900"
              }`}
            >
              Annual
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {plans.map(plan => (
            <div key={plan.id} className={`bg-white rounded-lg shadow-lg p-8 ${plan.id === "pro" ? "ring-2 ring-purple-500" : ""}`}>
              {plan.id === "pro" && (
                <div className="text-center mb-4">
                  <span className="bg-purple-500 text-white px-3 py-1 rounded-full text-sm font-semibold">Popular</span>
                </div>
              )}
