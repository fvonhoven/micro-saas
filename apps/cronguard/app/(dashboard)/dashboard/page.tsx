...
import { StatusGroupsTab } from "../../../components/StatusGroupsTab"
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"monitors" | "status-groups">("monitors")
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex gap-4 mb-6 border-b border-gray-200">
          ...
          <button
            onClick={() => setActiveTab("status-groups")}
            className={`px-4 py-2 border-b-2 transition-colors ${
              activeTab === "status-groups"
                ? "border-blue-600 text-blue-600 font-medium"
                : "border-transparent text-gray-600 hover:text-gray-900 hover:border-gray-300"
            }`}
          >
        ...
        {activeTab === "monitors" ? (
                    ...
                    <div key={monitor.id} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex flex-col items-end gap-3">
                          <span className={`px-4 py-2 rounded-full text-sm font-bold shadow-sm ${getStatusColor(monitor.status)}`}>
                            {monitor.status}
                          </span>
                          <div className="relative">
                            <button
          ...
          <StatusGroupsTab currentWorkspace={currentWorkspace} />
        )}
      </div>
